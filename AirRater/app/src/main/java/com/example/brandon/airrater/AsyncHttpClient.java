...
public class AsyncHttpClient {
     ...
     *
     * @param threadPool an instance of {@link java.util.concurrent.ThreadPoolExecutor} to use for queuing/pooling
     *                   requests.
     */
     ...
     * @param url             the URL to send the request to.
     * @param headers         set headers only for this request
     * @param entity          a raw {@link org.apache.http.HttpEntity} to send with the request, for example, use
